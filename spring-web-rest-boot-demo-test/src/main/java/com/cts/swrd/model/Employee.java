...
public class Employee {
	...
	@Min(value=25000 ,message="basic can not be less than 25k")
	@Max(value=450000,message="basic can not be greater than 45lakhs")
	...
	public Employee(
			...
			@Min(value = 25000, message = "basic can not be less than 25k") @Max(value = 450000, message = "basic can not be greater than 45lakhs") double basic,
			LocalDate joinDate, Department dept,
			@Pattern(regexp = "[1-9][0-9]{9}", message = "Mobile number is expected to be 10 digits") @NotNull(message = "Mobile number can not be omitted") String mobileNumber,
